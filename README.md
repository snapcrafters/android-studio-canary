...
<p align="center"><i>"Android Studio Canary is the early-access preview build of the IDE for Android"</i></p>
...
3. Configure your local repo. To make things a bit more intuitive, we will rename your fork's remote to `myfork`, and add the snapcrafters repo as `snapcrafters`.
   ...
   git remote add snapcrafters https://github.com/snapcrafters/android-studio-canary.git
   git fetch --all
   ```
